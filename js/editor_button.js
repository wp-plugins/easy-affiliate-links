...
EasyAffiliateLinks.openLightboxEdit = function(tinymce, id) {
    EasyAffiliateLinks.tinymce = tinymce;
    tb_show('Easy Affiliate Links', eafl_button.ajax_url + '&action=eafl_lightbox_edit&eafl_id=' + id + '&height=640&width=640&TB_iframe=true');
};
